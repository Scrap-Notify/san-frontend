...
export default function SidePanelHeader({
  ...
  return (
    <div className="flex h-14 items-center justify-between border-b border-[#00ffc2]/10 bg-[#101417]/80 px-4 backdrop-blur-md">
      <div className="flex items-center gap-2">
        <div className="text-lg font-bold text-[#00ffc2]">SAN</div>
      </div>
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-[#00ffc2]/30 text-[#00ffc2] transition hover:border-[#00ffc2]/70 hover:bg-[#00ffc2]/10 active:scale-[0.98]"
        ...
        <button
          type="button"
          className={[
            'flex h-8 w-8 items-center justify-center rounded-full border text-[10px] font-black transition',
            isAuthenticated
              ? 'border-[#00ffc2]/40 bg-[#00ffc2]/10 text-[#00ffc2]'
              : 'border-white/10 bg-[#262a2e] text-[#83958c]',
          ].join(' ')}
        ...
        >
          <span
            className={[
              ...
              isAuthenticated ? 'bg-[#00ffc2] shadow-[0_0_10px_#00ffc2]' : 'bg-[#83958c]',
            ].join(' ')}
          />
        </button>
      </div>
