...
const buttonToneStyles: Record<ButtonTone, string> = {
  primary:
    'bg-gradient-to-r from-[#00ffc2] to-[#00e1ab] text-[#007255] shadow-[0_20px_40px_rgba(0,255,194,0.2)] hover:opacity-95 active:shadow-[0_10px_24px_rgba(0,255,194,0.16)]',
