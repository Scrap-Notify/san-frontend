        ...
        <div className="flex shrink-0 gap-3">
          {[ArrowLeft, ArrowRight].map((Icon, index) => (
            <button
              key={index}
              type="button"
              className="flex h-11 w-11 items-center justify-center rounded-full border border-[#3a4a43] bg-[#181c1f]/40 text-[#b9cbc1] transition hover:border-primary-signal/60 hover:text-primary-signal sm:h-12 sm:w-12"
              ...
              >
                <div>
                  <div className="mb-7 flex items-start justify-between gap-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-bl-lg rounded-br-3xl rounded-tl-3xl rounded-tr-lg bg-[#1e5056]/30 text-primary-signal">
                      <Icon size={22} />
                    </div>
